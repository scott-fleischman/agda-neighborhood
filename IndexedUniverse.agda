...
module Run where
  pattern nil = la inl it ra
  pattern _::_ x xs = la inr (x / xs) ra
  infixr 5 _::_

  open Tree23 Le nowoto

  numbers10 numbers20 : MuJJ (q1 q+ qP q* qR) Nat
  numbers10 = 6 :: 10 :: 4 :: 5 :: 1 :: 9 :: 8 :: 2 :: 3 :: 7 :: nil
  numbers20 = 11 :: 17 :: 6 :: 18 :: 7 :: 15 :: 2 :: 4 :: 5 :: 13 :: 12 :: 10 :: 1 :: 9 :: 14 :: 20 :: 8 :: 16 :: 19 :: 3 :: nil

  sorted : <$ Le $>i+ (bot / top)
  sorted = sort numbers20
